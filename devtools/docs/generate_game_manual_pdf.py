...
def _build_story(font_name: str) -> list:
    ...
    story.append(
        p(
            ...
            "С <b>10 уровня</b> в профиле («Специализация») открывается выбор <b>базового класса</b> "
            "(статы сдвигаются в плюс и в минус от шаблона). "
            "С <b>50 уровня</b> — цепочка наставника и <b>высший гримуар</b> для смены специализации (tier‑2). "
            "Навыки изучаются через <b>гримуары</b>, не через древо SP.",
        ),
    )
    ...
    story.append(
        p(
            "<b>Города-хабы</b> между ярусами (<b>0↔1</b>, <b>30↔31</b>, <b>60↔61</b>, <b>90↔91</b>): "
            "кузница, таверна, лавка; в «Тихом Ручье» — рынок с храмом призыва.<br/>"
