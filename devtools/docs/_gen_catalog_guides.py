"""Run from tower_bot/: python devtools/docs/_gen_catalog_guides.py"""
...
def main() -> None:
    ...
    lines.extend(
        [
            ...
            "  • services/combat/combat_service.py — старт/победа в бою",
    ...
    from game.tower.quests import story_quests as sq_mod
    ...
    nlines.extend(
        [
            "============================================================================",
            "  NPC и задания",
            "  Сюжетные NPC этажа 1 (Тихий Ручей): game/tower/quests/story_quests.py",
            "============================================================================",
            "",
            "Связанные файлы:",
            "  • game/tower/quests/story_quests.py — тексты NPC, условия, награды",
            ...
            "  • game/tower/progression/wandering_npcs.py — странники",
    ...
    flines.extend(
        [
            ...
            "  Интерпретация в игре: game/tower/progression/floor_data.py",
            "============================================================================",
            "",
            "Связанные файлы:",
            "  • game/data/floors.py — ZONES_RAW, ZONE_FINAL_RAW, CITIES_RAW",
            "  • game/tower/progression/floor_data.py — get_zone_for_floor, get_city_for_floor, PORTAL_*",
            ...
            "  • game/tower/mechanics/ — explore, room_clear, wave, long_floor, registry",
            "  • game/enemies/floors/spawns.py — спауны по зоне и этажу",
            "  • game/tower/mechanics/zones/ — forest_beginnings, rotten_swamps",
