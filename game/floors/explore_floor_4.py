...
_MONSTER_TEMPLATES: list[MonsterTemplate] = [
    # Ключ ice_wolf — карточка из общего каталога (квест Эйрис считает «wolf» в ключе).
    MonsterTemplate("ice_wolf", "Лесной волк", "🐺", "ice", "Стая держит периметр у Тихого Ручья."),
