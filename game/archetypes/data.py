...
PASSIVES: dict[str, PassiveV2] = {
    ...
    # --- Tier 2 distinguishing passives (BALANCE_V2): осязаемые отличия от tier 1 ---
    "pas_grd_titan": PassiveV2("pas_grd_titan", "Гроза боссов", "Урон по боссам выше на 10%.", {"boss_dmg_mult": 1.10}),
    "pas_brs_blood": PassiveV2("pas_brs_blood", "Жажда крови", "+15% шанс кровотечения при ударе.", {"on_hit_bleed_chance": 0.15}),
    "pas_pyro_burn": PassiveV2("pas_pyro_burn", "Полыхание", "+15% шанс поджога при ударе.", {"on_hit_burn_chance": 0.15}),
    "pas_cryo_freeze": PassiveV2("pas_cryo_freeze", "Хладнокровие", "+12% шанс заморозить врага при ударе.", {"on_hit_freeze_chance": 0.12}),
    "pas_ass_mortal": PassiveV2("pas_ass_mortal", "Смертельный удар", "+12% шанс отравить врага при ударе.", {"on_hit_poison_chance": 0.12}),
    "pas_rng_focus": PassiveV2("pas_rng_focus", "Фокус охотника", "Урон по элитам выше на 10%.", {"elite_dmg_mult": 1.10}),
    "pas_pal_aegis": PassiveV2("pas_pal_aegis", "Эгида", "Получаемый урон ниже на 8%.", {"dmg_taken_mult": 0.92}),
    "pas_prp_blessing": PassiveV2("pas_prp_blessing", "Дар", "Восстанавливает 2% HP за ход.", {"hp_regen_pct_turn": 0.02}),
}
