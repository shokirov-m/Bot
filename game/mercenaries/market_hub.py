...
# Кратко: что можно делать на точке (квест/обмен за золото уже частично в bm:loc).
HUB_MECHANICS_RU: dict[str, str] = {
    "lots": "Витрина Жабса: лоты наёмников; после покупки — настройка в Доме.",
    "guard": "Пост: порядок и намёки на опасные проходы; мини-награда за «осмотр» уже начисляется при первом визите.",
    "forge_shadow": "Лавка теней: клинки на заказ; заготовка для будущих обменов редких материалов.",
    "alchemy": "Алхимик: зелья для духа наёмника; связка с эликсирами в городе.",
    "contracts": "Контракты: доставки и печати; повышенная награда за первый контракт в сессии.",
    "rumors": "Слухи: подсказки по этажам и тайникам; заготовка под цепочки исследований.",
}
