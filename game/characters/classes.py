...
CLASSES: dict[str, ClassDefinition] = {
    "wanderer": ClassDefinition(
        ...
        vitality=10,
        luck=8,
        passive_ru="Универсал до 10 ур.: на 11 ярусе наставник Эрид откроет путь — статы сдвинутся в плюс и в минус.",
    ...
    "star_touched": ClassDefinition(
        ...
        vitality=10,
        luck=16,
        passive_ru="Скрытый путь: удача выше остальных статов. Редкое откровение у Эрида на 11 ярусе.",
    ...
    "tower_reaper": ClassDefinition(
        ...
        vitality=11,
        luck=9,
        passive_ru="Скрытый путь: сотня побед и железная воля. У Эрида на 11 ярусе.",
