...
def main() -> None:
    from game.coliseum import coliseum_data as cd
    from game.coliseum import coliseum_rewards as cr
    ...
    from game.floors import wandering_npcs as wn
    from game.quests import npc_quests as nq
