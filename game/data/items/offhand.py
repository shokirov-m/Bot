...
def shield_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        # ОБЫЧНЫЕ (1-20)
        {
            ...
            "image_url": item_gear_png("recruit_shield"),
        ...
        },
        {
            ...
            "image_url": item_gear_png("duelist_buckler"),
            "export_floor_note": "1–20",
        },
        {
            "name": "Крышка от Люка",
            ...
            "image_url": item_gear_png("manhole_cover_shield"),
            "export_floor_note": "1–20",
        },
        # НЕОБЫЧНЫЕ (11-30)
        {
            ...
            "image_url": item_gear_png("tower_guard_shield"),
        ...
        },
        {
            ...
            "image_url": item_gear_png("protector_kappa"),
            "export_floor_note": "11–30",
        },
        {
            "name": "Зеркальный Щит",
            ...
            "image_url": item_gear_png("mirror_shield"),
            "export_floor_note": "11–30",
        },
        # РЕДКИЕ (21-50)
        {
            ...
            "image_url": item_gear_png("spiked_despair"),
        ...
        },
        {
            ...
            "image_url": item_gear_png("crossbowman_pavise"),
            "export_floor_note": "21–50",
        },
        {
            ...
            "image_url": item_gear_png("scarab_shell_shield"),
            "export_floor_note": "21–50",
        },
        # ЭПИЧЕСКИЕ (41-80)
        {
            ...
            "image_url": item_gear_png("sea_foam_aegis"),
        ...
        },
        {
            ...
            "image_url": item_gear_png("unbreakable_wall"),
            "export_floor_note": "41–80",
        },
        {
            ...
            "image_url": item_gear_png("void_dragon_scale"),
            "export_floor_note": "41–80",
        },
        # ЛЕГЕНДАРНЫЕ (70-90)
        {
            ...
            "image_url": item_gear_png("kings_bastion"),
        ...
        },
        {
            ...
            "image_url": item_gear_png("wailing_wall"),
            "export_floor_note": "70–90",
        },
        # МИФИЧЕСКИЕ (90+)
        {
            ...
            "image_url": item_gear_png("absolute_zero_shield"),
...
def grimoire_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        # ОБЫЧНЫЕ (1-20)
        {
            ...
            "image_url": item_gear_png("apprentice_notebook"),
            "export_floor_note": "1–20",
        },
        {
            ...
            "image_url": item_gear_png("dusty_truths_scroll"),
            "export_floor_note": "1–20",
        },
        # НЕОБЫЧНЫЕ (11-30)
        {
            ...
            "image_url": item_gear_png("green_flame_grimoire"),
            "export_floor_note": "11–30",
        },
        {
            "name": "Кодекс Перил",
            ...
            "image_url": item_gear_png("codex_of_perils"),
            "export_floor_note": "11–30",
        },
        # РЕДКИЕ (21-50)
        {
            ...
            "image_url": item_gear_png("dry_wind_folio"),
            "export_floor_note": "21–50",
        },
        {
            ...
            "image_url": item_gear_png("black_book_of_stairs"),
            "export_floor_note": "21–50",
        },
        # ЭПИЧЕСКИЕ (41-80)
        {
            ...
            "image_url": item_gear_png("astral_shadow_atlas"),
            "export_floor_note": "41–80",
        },
        {
            ...
            "image_url": item_gear_png("golden_dawn_grimoire"),
            "export_floor_note": "41–80",
        },
        # ЛЕГЕНДАРНЫЕ (70-90)
        {
            ...
            "image_url": item_gear_png("world_library"),
            "export_floor_note": "70–90",
        },
        # МИФИЧЕСКИЕ (90+)
        {
            ...
            "image_url": item_gear_png("tower_necronomicon"),
            "export_floor_note": "90+",
        },
        {
            ...
            "image_url": item_gear_png("book_of_beginning_and_end"),
            "export_floor_note": "90+",
        },
    ]
    return finalize_stub_list(rows)
...
def dagger_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        # ОБЫЧНЫЙ (1-20)
        {
            ...
            "image_url": item_gear_png("jagged_dagger"),
            "export_floor_note": "1–20",
        },
        # НЕОБЫЧНЫЙ (11-30)
        {
            ...
            "image_url": item_gear_png("shadow_dancer_blade"),
            "export_floor_note": "11–30",
        },
        # РЕДКИЙ (21-50)
        {
            ...
            "image_url": item_gear_png("asp_fang"),
            "export_floor_note": "21–50",
        },
        # ЭПИЧЕСКИЙ (41-80)
        {
            ...
            "image_url": item_gear_png("mercy_stiletto"),
            "export_floor_note": "41–80",
        },
        # ЛЕГЕНДАРНЫЙ (70-90)
        {
            ...
            "image_url": item_gear_png("lich_king_blade"),
            "export_floor_note": "70–90",
        },
        # МИФИЧЕСКИЙ (90+)
        {
            ...
            "image_url": item_gear_png("last_argument"),
            "export_floor_note": "90+",
        },
    ]
    return finalize_stub_list(rows)