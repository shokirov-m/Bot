...
# Ключ — after_floor: якорь полуэтажа города в башне (0.5, 30.5, …; в БД — 1000+якорь).
CITIES_RAW: dict[int, dict[str, Any]] = {
    0: {
        ...
        "name": "Тихий Ручей",
        "emoji": "🏘️",
        "theme_ru": "Деревня у подножия башни — тёплый безопасный очаг",
    },
    30: {
        "key": "ironfall",
        "after_floor": 30,
        "name": "Айронфолл",
        "emoji": "🏙️",
        "theme_ru": "Ледяной форпост — викинги, кузни и стойкие стены",
    },
    60: {
        "key": "emberhall",
        "after_floor": 60,
        "name": "Эмберхолл",
        "emoji": "🏙️",
        "theme_ru": "Последний огонь перед кровавыми залами Шпиля",
    },
    90: {
        "key": "eternis",
        "after_floor": 90,
        "name": "Этернис",
        "emoji": "🏙️",
        "theme_ru": "Город у порога Зала Вечности — свет и тишина",
    },
}
