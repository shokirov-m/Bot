...
VIP_STAR_GOODS: tuple[ShopGood, ...] = (
    ...
    ShopGood(
        key="vip_frost_throne_art",
        name="❄️ Владыка морозного трона",
        emoji="🖼",
        price=0,
        stars_price=100,
        blurb=(
            "Эксклюзивный арт для коллекции. После покупки навсегда:\n"
            "• <b>+5%</b> к золоту с победы (суммируется с титулами и прочими множителями).\n"
            "• <b>+15%</b> к элементальному урону, если ты бьёшь <b>льдом</b>: "
            "на оружии есть <b>руна льда</b> или твоя стихия персонажа — <b>лёд</b> "
            "(таблица слабостей врага + бонусы рун в бою)."
        ),
        item_data={
