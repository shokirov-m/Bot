...
from game.enemies.coliseum.fighters import SpecialId, fighter_by_id
...
def init_coliseum_fight(
    ...
    if spec == "monster_evasion_30":
        # Уклонение Аргуса задаётся в monster bundle (evasion), без дублирования через extra_miss_chance.
        logs.append("👁️ <b>Аргус:</b> враг «уворачивается» — тебе труднее попасть.")
    if spec == "aid_barrier":
