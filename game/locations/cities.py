...
class CityHubDef:
    ...
    economy_blurb: str
    """Кратко про лотерею / ростовщика / пожертвования в этом городе."""
...
_CITY_HUBS: dict[int, CityHubDef] = {
    3: CityHubDef(
        ...
        economy_blurb="Местная лотерея скромная; пожертвования идут в общий котёл деревни.",
    ),
    31: CityHubDef(
        key="ironfall",
    ...
    61: CityHubDef(
        ...
        economy_blurb="Банк гильдии кузнецов берёт плату за «опеку кошелька»; аукцион лотов пока вестится объявлениями у таверны.",
    ),
    91: CityHubDef(
        key="eternis",
        ...
        economy_blurb="Крупнейшая лотерея кольца, ростовщики небесных домов и пожертвования на печать против демонов.",
    ),
}
