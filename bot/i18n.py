...
STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "settings_reset_warn": (
            ...
            "Обнулятся этаж, инвентарь, квесты, золото, опыт, гримуары, титул и прочий прогресс в JSON. "
        ...
        "settings_stat_reset_warn": (
            ...
            "статы станут как у базового класса.\n\n"
        ...
        "hub_floor_line": "📍 Этаж <b>{floor}</b> · Ур. <b>{level}</b>",
