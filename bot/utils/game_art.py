"""Пути к изображениям в ``assets/game_art/`` (меню, NPC, бойцы колизея).
...
_ROOT = Path(__file__).resolve().parent.parent.parent / "assets" / "game_art"
_LEGACY_UI = Path(__file__).resolve().parent.parent.parent / "assets" / "ui"
