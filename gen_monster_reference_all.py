...
# Как в game/floors/monsters.py — мини-босс зоны
...
def main() -> int:
    ...
    out.append(
        ...
        "Источник ключей: `ZONE_POOL_KEYS`, боссы — как в `game/floors/monsters.py`."
    )
    out.append("")
    ...
    out.append("")
    out.append("*`game/floors/long_floor.py` — цепочка целей.*")
    out.append("")
