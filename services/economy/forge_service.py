...
from utils.telegram.ui import LINE_SEP, format_inventory_item_html, render_enchant_stars
...
def format_forge_intro_html(city_name: str, city_emoji: str) -> str:
    return (
        ...
        "<i>⚒️ Заточка надетой экипировки · починка прочности · рунный камень спасает от −1.</i>\n"
        "💬 <i>«Долгие рецепты — в Мастерской. Здесь — быстро и по делу.»</i>\n"
    )
