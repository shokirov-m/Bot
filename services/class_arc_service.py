...
from services.character_service import _compute_hp_max, _compute_mp_max


def apply_base_class(character: Character, class_key: str) -> bool:
    """Статы и HP/MP по шаблону класса; tier → 1. Возвращает False, если ключ неизвестен."""
    ...
    character.hp_max = max(1, _compute_hp_max(cls.vitality, cls.strength, cls))
    character.mp_max = max(0, _compute_mp_max(cls.intelligence, cls))
