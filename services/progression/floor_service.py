...
from utils.telegram.game_ui import push_game_ui, remember_game_ui_anchor
...
from game.tower.progression.tower_ascent import (
...
from services.progression.secret_chest_service import (
    SecretSearchOutcome,
    open_secret_chest,
...
from utils.media.image_assets import location_image_for_floor
from utils.telegram.ui import LINE_SEP, LINE_SEP_CITY
...
def format_floor_message(character: Character, *, defeated_slots: frozenset[str] | None = None) -> str:
    ...
    try:
        from game.tower.progression.aura import get_floor_aura
