...
from utils.media.image_assets import item_gear_png, item_gear_png_rarity
...
def shield_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "vit": 60,
            "int": 25,
            "summary": "Древний щит, покрытый письменами на неизвестном языке. Резьба по краю стёрлась — но металл всё ещё упрямо держит линию.",
        ...
        # МИФИЧЕСКИЕ (90+)
        {
            ...
            "defense": 450,
            "vit": 80,
            "summary": "Щит из вечного льда, который никогда не тает. От него веет таким холодом, что конденсат застывает на заклёпках.",
...
def grimoire_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        ...
        # ЛЕГЕНДАРНЫЕ (70-90)
        {
            ...
            "int": 65,
            "vit": 35,
            "summary": "В этой книге собраны вырезки из разных трактатов — каждый мир описан чужим почерком.",
        ...
        # МИФИЧЕСКИЕ (90+)
        {
            ...
            "int": 90,
            "vit": 60,
            "summary": "Переплёт из кожи неизвестного существа, страницы исписаны кровью. Запах старой железной соли.",
        ...
        },
        {
            ...
            "int": 100,
            "luck": 50,
            "summary": "Первая и последняя страница соприкасаются, образуя петлю закладок — глаз легко теряет, где начало текста.",
