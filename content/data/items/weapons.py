...
def weapon_main_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        ...
        # ЭПИЧЕСКИЕ (41-80) — с сильными эффектами
        {
            ...
            "int": 25,
            "weapon_type": "blade",
            "summary": "Клинок из светлого металла; блик режет глаз сильнее, чем ожидаешь от полированной стали.",
        ...
        },
        {
            ...
            "mp_bonus": 500,
            "weapon_type": "staff",
            "summary": "Тяжёлый посох с часовыми насечками на древке — будто ведёт счёт не ударам, а секундам.",
...
def weapon_offhand_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "dex": 25,
            "weapon_type": "dagger",
            "summary": "Кинжал с нагаром на лезвии и резким запахом трав. Царапина болезненнее обычной.",
        ...
        # МИФИЧЕСКИЕ (90+) — с уникальными эффектами
        {
            ...
            "luck": 50,
            "weapon_type": "dagger",
            "summary": "Клинок невероятно лёгкий — кажется, что держишь только остаток тени.",
...
def two_handed_weapon_examples() -> list[dict[str, Any]]:
    ...
    rows: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "mp_bonus": 300,
            "weapon_type": "staff",
            "summary": "Посох из сердцевины ледяного кристалла — ладонь онемевает быстрее, чем от зимнего ветра.",
        ...
        # МИФИЧЕСКИЕ (90+) — с уникальными эффектами
        {
            ...
            "vit": 60,
            "weapon_type": "hammer",
            "summary": "Молот не по размеру тяжёлый — земля под ногами отзывается даже на замахе.",
